// Ensure you have 'use client' directive if required at the top
    ...
    >
      ...
      >
        {experienceData.map((data, i) => (
          ...
          >
            <motion.div 
              ...
              tracking-wide sm:text-sm dark:bg-zinc-700 transition-colors z-20"
            >  
              <h1 className="text-xl sm:text-lg font-light text-gray-700 dark:text-gray-300">{data.title}</h1>
            ...
            <div 
              className={`w-14 absolute top-20 border border-gray-300 rounded-full aspect-square grid 
              place-items-center text-red-400 font-light -translate-y-1/2 z-10 transition-colors duration-500 bg-white dark:bg-zinc-800 ${
                i % 2 === 0 
        ...
        <motion.div 
          ...
          className="absolute w-1 h-full rounded-full bg-gray-300 origin-top transition-colors duration-500 dark:bg-gray-700" 
        ></motion.div>
      </div>
    </div>
  );
